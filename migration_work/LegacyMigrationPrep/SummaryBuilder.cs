...
{
    public static string Build(PreparedMigration prepared)
    {
        return $$"""
        ...
        - Customers: {{prepared.Customers.Count}}
        - Products: {{prepared.Products.Count}}
        - Accounts: {{prepared.Accounts.Count}}
        - Loans: {{prepared.Loans.Count}}
        - Customer enrichment rows: {{prepared.CustomerEnrichment.Count}}
        - Loan enrichment rows: {{prepared.LoanEnrichment.Count}}
        - Cheque inventory rows: {{prepared.ChequeInventory.Count}}
