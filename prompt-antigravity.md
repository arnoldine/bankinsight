...
I want to build a web app that uses a simulation of **PostgreSQL** as the backend. The app is called **BankInsight**. It is a React-based Core Banking System simulation that mimics the functionality of an Relational database environment, specifically tailored for Bank of Ghana compliance.
...
- **Backend Simulation**: A custom hook (`useBankingSystem`) that manages state as if it were a Relational (SQL) database.
- **AI Integration**: Google Gemini API for generating insights, PL/pgSQL code, and data migration mapping.
...
{
  "name": "BankInsight",
  "description": "A Bank of Ghana compliant Core Banking System simulation using React frontend and PostgreSQL PL/pgSQL backend logic.",
...
import UserManagement from './components/UserManagement'; // Import the new engine
...
import UserManagement from './components/UserManagement'; // Import new manager
import TransactionExplorer from './components/TransactionExplorer';
import UserManagement from './components/UserManagement'; // Import Transaction Explorer
import UserProfile from './components/UserProfile';
import UserManagement from './components/UserManagement';
import Settings from './components/Settings';
import UserManagement from './components/UserManagement'; // New Settings Component
import DevelopmentTasks from './components/DevelopmentTasks';
import UserManagement from './components/UserManagement'; // New Tasks Component
import EodConsole from './components/EodConsole';
import UserManagement from './components/UserManagement'; // Import EOD Console
import GroupManager from './components/GroupManager';
import UserManagement from './components/UserManagement'; // Import Group Manager
import ProductDesigner from './components/ProductDesigner';
import UserManagement from './components/UserManagement'; // Import Product Designer
import ApprovalInbox from './components/ApprovalInbox';
import UserManagement from './components/UserManagement'; // Import Approval Inbox
import LoginScreen from './components/LoginScreen';
import UserManagement from './components/UserManagement'; // New Login
import StatementVerification from './components/StatementVerification';
import UserManagement from './components/UserManagement'; // New Module
