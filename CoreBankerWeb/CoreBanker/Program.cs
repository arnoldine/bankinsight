...
builder.Services.AddScoped<CoreBanker.Services.UserService>();
builder.Services.AddScoped<CoreBanker.Services.AdminService>();
...
builder.Services.AddScoped<CoreBanker.Services.EndOfDayService>();
