...
public static class AppPermissions
{
    ...
    public static class Accounts { public const string View = "accounts.view"; public const string ViewConfidential = "accounts.view.confidential"; public const string Open = "accounts.open"; public const string Edit = "accounts.edit"; public const string Close = "accounts.close"; public const string Freeze = "accounts.freeze"; public const string Reactivate = "accounts.reactivate"; }
    public static class Loans { public const string View = "loans.view"; public const string ViewConfidential = "loans.view.confidential"; public const string Create = "loans.create"; public const string Edit = "loans.edit"; public const string Approve = "loans.approve"; public const string Disburse = "loans.disburse"; public const string Restructure = "loans.restructure"; public const string WriteOff = "loans.writeoff"; public const string Reschedule = "loans.reschedule"; public const string ConfigureProducts = "loans.products.configure"; }
    public static class Investments { public const string View = "investments.view"; public const string ViewConfidential = "investments.view.confidential"; public const string Create = "investments.create"; public const string Approve = "investments.approve"; }
